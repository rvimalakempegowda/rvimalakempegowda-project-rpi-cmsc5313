...
# doc_Temperature_humidity_ref = collection.document(constant.DOCUMENT_HYGROTHERMOGRAPH)


# def uploadFirebase(temperature, humidity, preTempreature , preHumidity):
#     if(preHumidity != humidity or preTempreature !=temperature):
#         print('uploading') 
#         doc_Temperature_humidity_ref.update({u'Temperature': temperature,'Humidity':humidity})  
